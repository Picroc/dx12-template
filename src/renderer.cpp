...
void Renderer::OnUpdate()
{
	...
	//world *= XMMatrixTranslation(delta_x, delta_y, delta_z);
...
void Renderer::LoadAssets()
{
	...
	ThrowIfFailed(D3DCompileFromFile(shader_path.c_str(), nullptr, nullptr, "VSMain", "vs_5_0",
		compile_flags, 0, &vertex_shader, &error));
	ThrowIfFailed(D3DCompileFromFile(shader_path.c_str(), nullptr, nullptr, "PSMain", "ps_5_0",
	...
	/*ColorVertex triangle_verticies[] = {
	...
	const UINT vertex_buffer_size = sizeof(ColorVertex) * verticies.size();
	...
	memcpy(vertex_data_begin, verticies.data(), vertex_buffer_size);
...
void Renderer::PopulateCommandList()
{
	...
	command_list->DrawInstanced(verticies.size(), 1, 0, 0);
